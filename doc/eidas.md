...
[published as open source](https://ec.europa.eu/cefdigital/wiki/display/CEFDIGITAL/Technical+Specifications)
...
[instructions provided by the EC](https://ec.europa.eu/cefdigital/wiki/display/CEFDIGITAL2018/eIDAS-Node+-+Current+release).
...
If the user selects the option for authenticating european citizens, they are
