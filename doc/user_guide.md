...
-   [User Guide](#def-user-guide) - [Logging in](#def-logging) -
    [Applications](#def-applications) - [List of applications](#def-list-apps) -
...
Go to "Sign in" if you heave previously created an account, otherwise "Sign up"
...
Once you have logged successfully, you will be redirect to the home page where
