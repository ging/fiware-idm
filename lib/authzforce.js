...
function get_application_domain(domain) {
	...
	return new Promise(function(resolve, reject) {
		...
		if (!domain.az_domain) {
			...
			ejs.renderFile(__dirname + '/../templates/authzforce/domain.ejs', {app_id: domain.oauth_client_id}, function(error, body) {
...
function policy_set_update(application_id, az_domain, policy_version, policy, role_permissions) {
	...
	return new Promise(function(resolve, reject) {
		...
		ejs.renderFile(__dirname + '/../templates/authzforce/policy_set.ejs', context, function(error, body) {
...
function activate_policy(az_domain, policy, version_policy) {
	...
	return new Promise(function(resolve, reject) {
		...
		ejs.renderFile(__dirname + '/../templates/authzforce/policy_properties.ejs', {'policy_id': policy }, function(error, body) {
			if (!error) {
