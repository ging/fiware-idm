...
sign_metadata = function(xml, private_key, options, certificate) {
  ...
  var replaced = signer.getSignedXml().replace('URI="#_0"', 'URI=""');
  return replaced;
};
...
sign_request = function(saml_request, private_key, relay_state, response) {
  ...
  data += "&SigAlg=" + encodeURIComponent('http://www.w3.org/2001/04/xmldsig-more#rsa-sha512');
  ...
  sigalg_data = "&SigAlg=" + encodeURIComponent('http://www.w3.org/2001/04/xmldsig-more#rsa-sha512');
  ...
  samlQueryString.SigAlg = 'http://www.w3.org/2001/04/xmldsig-more#rsa-sha512';
    ...
    function(cb_wf) {
      ...
      */
      ...
      try {
        ...
        assertion = saml_response.getElementsByTagNameNS(XMLNS.SAML, 'Assertion');
        signed_dom = (new xmldom.DOMParser()).parseFromString(assertion[0].toString());
        // -------- 
        
        session_info = get_session_info(/*decrypted_assertion*/signed_dom, require_session_index);
        user.name_id = get_name_id(/*decrypted_assertion*/signed_dom);
        ...
        assertion_attributes = parse_assertion_attributes(/*decrypted_assertion*/signed_dom);
...
module.exports.ServiceProvider = ServiceProvider = (function() {
  function ServiceProvider(options) {
    ...
    this.entity_id = options.entity_id, this.private_key = options.private_key, this.metadata_private_key = options.metadata_private_key, this.certificate = options.certificate, this.metadata_certificate = options.metadata_certificate, this.assert_endpoint = options.assert_endpoint, this.alt_private_keys = options.alt_private_keys, this.alt_certs = options.alt_certs;
  ...
  ServiceProvider.prototype.create_authn_request_xml = function(identity_provider, options) {
    ...
    console.log('MALO ***********************+', xml);

    var new_xml = '<saml2p:AuthnRequest xmlns:saml2p="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eidas="http://eidas.europa.eu/saml-extensions" xmlns:saml2="urn:oasis:names:tc:SAML:2.0:assertion" Consent="urn:oasis:names:tc:SAML:2.0:consent:unspecified" Destination="http://eidas.dit.upm.es:8080/EidasNode/ServiceProvider" ForceAuthn="true" ID="_Yq046doqCwO9wZgtZH3k5gOXW-RevJ2xarJ27QMlhq5YYpWU96adxsUmujPnDF1" IsPassive="false" IssueInstant="2018-10-16T12:05:00.659Z" ProviderName="DEMO-SP-CA" Version="2.0"><saml2:Issuer Format="urn:oasis:names:tc:SAML:2.0:nameid-format:entity">http://yosi.dit.upm.es:3000/idm/applications/14c1d04d-d784-4e1e-8809-893ed5b0ea50/saml2/metadata</saml2:Issuer><saml2p:Extensions><eidas:SPType>public</eidas:SPType><eidas:RequestedAttributes><eidas:RequestedAttribute FriendlyName="D-2012-17-EUIdentifier" Name="http://eidas.europa.eu/attributes/legalperson/D-2012-17-EUIdentifier" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="EORI" Name="http://eidas.europa.eu/attributes/legalperson/EORI" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="LEI" Name="http://eidas.europa.eu/attributes/legalperson/LEI" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="LegalName" Name="http://eidas.europa.eu/attributes/legalperson/LegalName" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="LegalAddress" Name="http://eidas.europa.eu/attributes/legalperson/LegalPersonAddress" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="LegalPersonIdentifier" Name="http://eidas.europa.eu/attributes/legalperson/LegalPersonIdentifier" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="SEED" Name="http://eidas.europa.eu/attributes/legalperson/SEED" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="SIC" Name="http://eidas.europa.eu/attributes/legalperson/SIC" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="TaxReference" Name="http://eidas.europa.eu/attributes/legalperson/TaxReference" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="VATRegistration" Name="http://eidas.europa.eu/attributes/legalperson/VATRegistrationNumber" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="BirthName" Name="http://eidas.europa.eu/attributes/naturalperson/BirthName" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="CurrentAddress" Name="http://eidas.europa.eu/attributes/naturalperson/CurrentAddress" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="FamilyName" Name="http://eidas.europa.eu/attributes/naturalperson/CurrentFamilyName" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="FirstName" Name="http://eidas.europa.eu/attributes/naturalperson/CurrentGivenName" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="DateOfBirth" Name="http://eidas.europa.eu/attributes/naturalperson/DateOfBirth" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="Gender" Name="http://eidas.europa.eu/attributes/naturalperson/Gender" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="PersonIdentifier" Name="http://eidas.europa.eu/attributes/naturalperson/PersonIdentifier" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="true"/><eidas:RequestedAttribute FriendlyName="PlaceOfBirth" Name="http://eidas.europa.eu/attributes/naturalperson/PlaceOfBirth" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="Citizenship" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/Citizenship" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="CountryOfBirth" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/CountryOfBirth" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="CurrentPhoto" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/CurrentPhoto" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="EhicId" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/EhicId" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="Email" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/Email" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="MaritalState" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/MaritalState" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="Nationality" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/Nationality" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="Phone" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/Phone" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="TemporaryAddress" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/TemporaryAddress" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="IdExpiryDate" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/id/ExpiryDate" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="IdIssuer" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/id/Issuer" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="IdNumber" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/id/Number" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="IdType" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson/id/Type" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="CurrentDegree" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/CurrentDegree" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="CurrentLevelOfStudy" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/CurrentLevelOfStudy" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="Degree" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/Degree" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="DegreeAwardingInstitution" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/DegreeAwardingInstitution" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="DegreeCountry" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/DegreeCountry" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="FieldOfStudy" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/FieldOfStudy" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="GraduationYear" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/GraduationYear" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="LanguageCertificates" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/LanguageCertificates" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="LanguageProficiency" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/LanguageProficiency" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="HomeInstitutionAddress" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/homeinstitution/Address" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="HomeInstitutionCountry" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/homeinstitution/Country" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="HomeInstitutionIdentifier" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/homeinstitution/Identifier" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="HomeInstitutionName" Name="http://eidas.europa.eu/attributes/sectorspecific/eid4u/studies/homeinstitution/Name" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/><eidas:RequestedAttribute FriendlyName="TaxIdentificationNumber" Name="http://eidas.europa.eu/attributes/sectorspecific/naturalperson/TaxIdentificationNumber" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:uri" isRequired="false"/></eidas:RequestedAttributes></saml2p:Extensions><saml2p:NameIDPolicy AllowCreate="true" Format="urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified"/><saml2p:RequestedAuthnContext Comparison="minimum"><saml2:AuthnContextClassRef>http://eidas.europa.eu/LoA/low</saml2:AuthnContextClassRef></saml2p:RequestedAuthnContext></saml2p:AuthnRequest>';
  ...
  ServiceProvider.prototype.create_metadata = function() {
    ...
    return sign_metadata(xml_meta, this.metadata_private_key, options, this.metadata_certificate);
  };
