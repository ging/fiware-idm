...
XMLNS = {
  ...
  EID4UP:
    'http://eidas.europa.eu/attributes/sectorspecific/eid4u/naturalperson',
};
...
parse_assertion_attributes = function(dom) {
  ...
  for (j = 0, len = ref1.length; j < len; j++) {
    ...
    if (attribute_name !== 'CurrentPhoto') {
      ...
      var photo_xml = attribute.getElementsByTagNameNS(
        XMLNS.SAML,
        'AttributeValue'
      );
      attribute_values = photo_xml.getElementsByTagNameNS(
        XMLNS.EID4UP,
        'document'
      );
    }
