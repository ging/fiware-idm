...
TokenHandler.prototype.getClientCredentials = function(request) {
  // console.log("=====getClientCredentials=====")
  if (!request.query.response_type) {
  ...
  if (request.query.client_id/* && request.body.client_secret*/) {
    return { clientId: request.query.client_id, clientSecret: null /*request.body.client_secret*/ };
  }
  ...
  if (!this.isClientAuthenticationRequired(grantType)) {
    if(request.body.client_id) {
      ...
      return { clientId: request.query.client_id };
    }*/
  }
...
TokenHandler.prototype.getAccessTokenLifetime = function(client) {
  // console.log("=====GetAccessTokenLifeTime=====")
...
TokenHandler.prototype.getRefreshTokenLifetime = function(client) {
  // console.log("=====getRefreshTokenLifeTime=====")
...
TokenHandler.prototype.isClientAuthenticationRequired = function(grantType) {
  // console.log("=====isClientAuthenticationRequired =====")
