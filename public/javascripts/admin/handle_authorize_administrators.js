...
$(document).ready(function() {
    ...
    $('#members__action_manage_administrators').click(function () {
        ...
        var url = "/idm_admin/admin_users?limit=all"
            ...
            if (data.type === 'error') {
                ...
                if (admin_users.length > 0) {
                    for (var i = 0; i < admin_users.length; i++) {
                        ...
                        assign_role_user_row = assign_role_user_row.replace(/username/g, htmlEntities(admin_users[i].username));
                        assign_role_user_row = assign_role_user_row.replace(/user_id/g, String(admin_users[i].id));
                        assign_role_user_row = assign_role_user_row.replace(/user_avatar/g, String(admin_users[i].image));
