$(document).ready(function(){
	...
	$('#organization_applications').find('.ajax-tabs').on('click', 'li.role', function() {
	...
	$('#select_org').bind('click', function() {
		...
		$('#organization_applications').find('#authorized_table_content').empty()
		$('#organization_applications').find('[data-target="#panel_tabs_org_providing_tab"]').attr('data-loaded', 'false')
		$('#organization_applications').find('[data-target="#panel_tabs_org_purchased_tab"]').attr('data-loaded', 'false')
		$('#organization_applications').find('[data-target="#panel_tabs_org_authorized_tab"]').attr('data-loaded', 'false')
		$('#organization_applications').find('#panel_tabs').children().removeClass('active')
		$('#organization_applications').find('#panel_tabs').children().first().addClass('active')
		$('#organization_applications').find('.tab-pane').removeClass('active')
		$('#organization_applications').find('#panel_tabs_org_providing_tab').addClass('active')
		org_change_role('/idm/applications/filtered_organization?role=provider', $('#organization_applications').find('#panel_tabs').find('li:first').find('a:first'))
	})
