      ...
      return (
            ...
            (o = (function(o) {
              return function(n) {
                if (
                  ...
                  t(window).off('resize.tour-' + o._options.name),
                  t(window).off('scroll.tour-' + o._options.name),
                  o._setState('end', 'yes'),
                  (o._inited = !1),
                  (o._force = !1),
                  o._clearTimer(),
        ...
        (o.prototype._showPopover = function(e, o) {
          ...
          if (
            ...
            (a = !0 === e.smartPlacement && -1 === e.placement.search(/auto/i)),
            n
              .popover({
            ...
            (i = n.data('bs.popover')
              ...
              : n.data('popover').tip()).attr('id', e.id),
            'fixed' === n.css('position') && i.css('position', 'fixed'),
            this._reposition(i, e),
            r)
          )
            return this._center(i);
        }),
        ...
        (o.prototype._reposition = function(o, n) {
          ...
          if (
            ...
            (h = u.left),
            (p = u.top),
            (i = t(e).outerHeight() - u.top - o.outerHeight()) < 0 &&
              (u.top = u.top + i),
            (s = t('html').outerWidth() - u.left - o.outerWidth()) < 0 &&
              (u.left = u.left + s),
            u.top < 0 && (u.top = 0),
            u.left < 0 && (u.left = 0),
            o.offset(u),
            ...
            if (h !== u.left)
              return this._replaceArrow(o, 2 * (u.left - h), a, 'left');
          } else if (p !== u.top)
            return this._replaceArrow(o, 2 * (u.top - p), r, 'top');
        }),
