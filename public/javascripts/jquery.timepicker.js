  ...
  (function() {
    ...
    $.TimePicker.prototype = {
      ...
      _items: function(i, startTime) {
        ...
        while (time < end) {
          if (widget._isValidTime(i, time)) {
            ...
            $('<a>')
              .addClass('ui-corner-all')
              .text($.fn.timepicker.formatTime(i.options.timeFormat, time))
              .appendTo(item);
      ...
      first: function(i) {
        if (this.instance === i) {
          return (
            this.active && this.active.prevAll('.ui-menu-item').length === 0
          );
        }
        return false;
      },
      ...
      last: function(i) {
        if (this.instance === i) {
          return (
            this.active && this.active.nextAll('.ui-menu-item').length === 0
          );
        }
        return false;
      },
      ...
      open: function(i) {
        ...
        $(document).bind(
          'click.timepicker-' + i.element.data('timepicker-event-namespace'),
          function(event) {
        ...
        var containerDecorationHeight =
            widget.container.outerHeight() - widget.container.height(),
