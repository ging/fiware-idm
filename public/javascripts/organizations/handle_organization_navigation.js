$(document).ready(function(){
	...
	// Init some values
	change_role('?tab=panel_tabs__owned_organizations_tab', $('#panel_tabs').find('li:first').find('a:first'))
	...
	function owned_organizations(max) {
		...
		$('#owned_organizations_pagination_container').bootpag({
	...
	function member_organizations(max) {
		...
		$('#member_organizations_pagination_container').bootpag({
		    total: Math.ceil(max/5),
		    page: 1,
		    maxVisible: 5,
		    leaps: true,
