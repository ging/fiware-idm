...
const api_user_org_assign_controller = require('../../controllers/api/index')
...
router.put(
  '/:user_id/organization_roles/:organization_role_id',
  api_user_org_assign_controller.addRole
);
router.delete(
  '/:user_id/organization_roles/:organization_role_id',
  api_user_org_assign_controller.removeRole
);
