...
router.get('/prueba',   sessionController.loginRequired,    applicationController.prueba);
router.post('/idm/applications/:applicationId/edit/roles',   sessionController.loginRequired,    applicationController.create_role);
