...
const web_list_users_controller = require('../../controllers/web/index')
  .list_users;
...
router.get(
  '/administrators',
  csrf_protection,
  web_admin_controller.index_administrators
);
router.put(
  '/administrators',
  csrf_protection,
  web_admin_controller.update_administrators
);
router.get(
  '/administrators/list',
  csrf_protection,
  web_admin_controller.admin_users
);
...
router.get(
  '/list_users/users',
  csrf_protection,
  web_list_users_controller.index
);
router.post(
  '/list_users/users',
  csrf_protection,
  web_list_users_controller.create
);
router.delete(
  '/list_users/users',
  csrf_protection,
  web_list_users_controller.delete
);
router.put(
  '/list_users/users/:user_id/edit_info',
  csrf_protection,
  web_list_users_controller.edit_info
);
router.put(
  '/list_users/users/:user_id/change_password',
  csrf_protection,
  web_list_users_controller.change_password
);
router.put(
  '/list_users/users/:user_id/enable',
  csrf_protection,
  web_list_users_controller.enable
);
