...
router.post('/password/reset',      csrfProtection,   web_user_controller.change_password);
router.get('/confirmation',         csrfProtection,   web_user_controller.confirmation);
router.post('/confirmation',        csrfProtection,   web_user_controller.resend_confirmation);
