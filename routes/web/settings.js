...
router.post('/password',       parseForm,  csrfProtection,     web_setting_controller.password);
router.post('/email',          web_session_controller.password_check_date,  parseForm,  csrfProtection,  web_setting_controller.email);
router.get('/email/verify',    web_session_controller.password_check_date,  csrfProtection,  web_setting_controller.email_verify);
router.delete('/cancel',       web_session_controller.password_check_date,  parseForm,  csrfProtection,  web_setting_controller.cancel_account);
